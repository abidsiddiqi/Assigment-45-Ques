...
/*Note: */
/* Make a list of five or more usernames called current_users. */
let current_users = ['abdullah', 'abid', 'admin', 'saad', 'hassaan'];
/**Make another list of five usernames called new_users. Make sure one or two of the new usernames are also in the current_users list. */
let new_users = ['ali', 'shahid', 'abid'];
// adding a new user
...
function IsNameAvailable(userName, newUser) {
...
function AddNewUser(newUsers, newUser) {
    const nameAvailable = IsNameAvailable(newUsers, newUser);
...
/*
 * *********** output: *******************
 Welcome abid! , you account has been created successfully!
[ 'ali', 'shahid', 'abid' ]
